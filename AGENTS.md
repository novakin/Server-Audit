...
- Use Europe/Berlin dates for human-written project records, with the timezone stated. Retain machine timestamps in UTC or with an explicit offset. Do not change historical event dates to the document-edit date or imply old runs were repeated.
